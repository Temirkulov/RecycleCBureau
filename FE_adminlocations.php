...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM recycling_centre WHERE id LIKE '%$search%' OR street LIKE '%$search%' OR city LIKE '%$search%' OR notes LIKE '%$search%';";
} else {
...
<h2 class="logo">Logo</h2>
		...
		<nav class="navigation">
			...
			<div class="search">
			    <form action="BE_adminlocations.php" method="get">
...
<section class="about">
    ...
    <p>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo '<thead><tr style="border-bottom: 1px solid white;color: white;"><th>ID</th><th>Street</th><th>City</th><th>notes</th><th>action</th></tr></thead>';
            echo '<tbody>';
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td style="border-right: 1px solid white; height: 50px;color: white;">' . '<a href="BE_locations.delete.php?id=' . $row["id"] . '">Delete</a>' . '</td>';
                echo '</tr>';
            }
